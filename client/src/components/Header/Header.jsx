...
const Header = () => {
    return (
        <div className='w-full sticky top-0 left-0 grid grid-cols-[1fr_2fr_1fr] gap-5 items-center bg-zinc-50 border-b border-zinc-200 px-10 py-2'>
            ...
            <div className="flex justify-end gap-3">
                ...
                <button className='inline-flex items-center gap-2 bg-zinc-200 pl-2 pr-5 cursor-pointer rounded-full border border-gray-300 duration-200 hover:scale-95 hover:skew-1 hover:bg-zinc-300'>
